      ...
      <div class="input-form col-md-12 mx-auto">
        ...
        <form class="validation-form" id="memberinsertform" name ="memberinsertform" novalidate>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="memname" name = "memname" placeholder="" value="<%= mvo.getMemname() %>" required readonly>
		...
		<div class="custom-control custom-radio custom-control-inline">
         ...
         <!-- 아이디 -->
          <div class="mb-3">
              ...
              <input type="text" class="form-control" id="memid" name = "memid" value="<%= mvo.getMemid() %>"  readonly>
              <div class="invalid-feedback">
                아이디를 입력해주세요.
              </div>
          </div>
         ...
         <!-- 비밀번호 -->
          ...
          <input type="hidden" id="memid" name="memid" value="<%= mvo.getMemid() %>">
          </div>
      <%
	}	
%>         
