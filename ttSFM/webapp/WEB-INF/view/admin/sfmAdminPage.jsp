...
<link rel="stylesheet" type="text/css" href="/ttSFM/include/sfmAdminPage.css">
...
<!-- 상단 로고 -->
<!-- 관리자 버튼!! -->
<div id="naviarea" style="background-color: #ffffff;">
<header id="topbar">
	<ul class="wrapper mb">
		<!-- 메뉴버튼들 ----------------------->
		<li>
