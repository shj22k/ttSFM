...
<%
	...
	logger.info("shjMatchMap.jsp >>> : ");
	
	String jibun = request.getParameter("jibun");
	logger.info("jibun >>> : " + jibun);
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c096c8fca8e2c9ab4cf4ea07da33fe25&libraries=services"></script>
<script>
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var imageSrc = '/ttSFM/img/football.png', // 마커이미지의 주소입니다    
		...
		var iwContent = '<div style="padding:5px;"><%= stadium %></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
